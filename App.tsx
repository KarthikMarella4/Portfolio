  ...
  return (
    <div className="min-h-screen bg-[#F3F3F3] text-black font-sans selection:bg-orange-500 selection:text-white overflow-x-hidden relative">
      ...
      <nav className={`fixed top-0 w-full z-40 transition-all duration-300 flex justify-between items-center px-6 md:px-12 py-6 
        ${scrolled
          ? 'bg-[#F3F3F3]/90 backdrop-blur-md border-b border-black/5'
          : 'bg-transparent'
        }`}>
      ...
      {/* --- Hero Section --- */}
      <header className="relative px-6 md:px-12 pt-32 pb-20">
        <div className="max-w-7xl w-full mx-auto">
          <FadeIn delay={700}>
            <div className="flex gap-4 items-center">
              <span className="animate-bounce">↓</span>
              <span className="font-mono text-sm tracking-widest text-gray-400">SCROLL TO EXPLORE</span>
            </div>
          </FadeIn>
        </div>
      </header>
...
" />
      ...
      {/* --- About Section --- */}
      <section id="about" className="py-24 px-6 md:px-12 bg-white text-black relative border-b border-black transition-colors duration-500">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-12 gap-12 items-start relative z-10">
          ...
          <div className="md:col-span-5">
            <FadeIn>
              <div className="sticky top-32">
                <h2 className="text-7xl md:text-9xl font-black uppercase tracking-tighter mb-8 leading-[0.8] text-black">
                  About<br />
                  <span className="text-orange-600">Me.</span>
                </h2>
                <div className="h-2 w-24 bg-orange-600 mt-8"></div>
              </div>
            </FadeIn>
          </div>
          ...
          <div className="md:col-span-7 pt-4">
            <FadeIn delay={200}>
              <div className="space-y-8 text-lg md:text-xl font-medium leading-relaxed text-gray-800">
                <p className="first-letter:text-5xl first-letter:font-black first-letter:text-black first-letter:mr-3 first-letter:float-left">
                  I am an AI & Machine Learning Engineer specializing in building intelligent systems using Deep Learning, Generative AI, and Large Language Models (LLMs). I focus on developing scalable, production-ready solutions by integrating AI agents, DevOps, and cloud-native technologies.
                </p>
                <p>
                  Passionate about solving real-world problems, I design intuitive, user-centric AI solutions that improve everyday workflows. I continuously explore emerging AI tools, automation, and orchestration platforms like n8n to build smarter, efficient, and reliable systems.
                </p>
                ...
                <div className="mt-8 pt-8 border-t border-black/10">
                  ...
                  <div className="space-y-4">
                    <div className="bg-black p-6 rounded-2xl border border-white/10 hover:border-orange-500/50 transition-colors">
                      <h4 className="text-lg font-bold text-white mb-1">Bachelor of Technology</h4>
                      <p className="text-orange-500 font-medium mb-2">Artificial Intelligence and Machine Learning</p>
                      <div className="flex flex-wrap justify-between items-end gap-4 text-sm font-mono text-gray-400">
                        <span>Aditya College of Engineering</span>
                        <span className="font-bold text-white">CGPA: 7.52</span>
                        <span>2020 — 2024</span>
                      </div>
                    </div>
                    <div className="bg-black p-6 rounded-2xl border border-white/10 hover:border-orange-500/50 transition-colors">
                      <h4 className="text-lg font-bold text-white mb-1">Intermediate</h4>
                      <p className="text-orange-500 font-medium mb-2">MPC</p>
                      <div className="flex flex-wrap justify-between items-end gap-4 text-sm font-mono text-gray-400">
                        <span>Aditya Junior College</span>
                        <span className="font-bold text-white">CGPA: 9.13</span>
                        <span>2018 — 2020</span>
                      </div>
                    </div>
                  </div>
      ...
      <section id="certifications" className="py-32 px-6 md:px-12 relative overflow-hidden bg-[#F3F3F3] text-black">
        {/* Decorative elements - subtle for light mode */}
        <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-orange-500/5 rounded-full blur-[100px] pointer-events-none transform translate-x-1/2 -translate-y-1/2"></div>

        <div className="max-w-7xl mx-auto relative z-10">
          <FadeIn>
            <div className="mb-20 text-center">
              <span className="font-mono text-sm font-bold uppercase tracking-[0.3em] text-orange-500 mb-4 block">Verified Credentials</span>
              <h2 className="text-5xl md:text-7xl font-black uppercase tracking-tighter text-black">Certifications</h2>
            </div>
          </FadeIn>
            ...
            {CERTIFICATIONS.map((cert) => (
              <FadeIn key={cert.id} delay={cert.id * 100}>
                <a
                  ...
                  className="cert-card block group cursor-pointer bg-gray-50 border border-gray-200 hover:border-orange-500/50 hover:bg-white hover:shadow-xl transition-all duration-300"
                >
                  <div className="flex items-start justify-between mb-6">
                    <Award className="w-10 h-10 text-orange-600 group-hover:text-orange-500 transition-colors duration-300" />
                    <ExternalLink className="w-5 h-5 text-gray-400 opacity-0 group-hover:opacity-100 transition-all duration-300 transform group-hover:-translate-y-1" />
                  </div>
                  <h3 className="text-xl font-black uppercase leading-tight mb-3 text-black group-hover:text-orange-600 transition-colors duration-300">{cert.title}</h3>
                  <div className="flex items-center gap-2 mt-auto">
                    <span className="inline-block w-2 h-2 rounded-full bg-orange-600"></span>
                    <p className="font-mono text-xs font-bold text-gray-500 uppercase tracking-wider">{cert.issuer}</p>
                  </div>
                </a>
              </FadeIn>
            ))}
      ...
      {/* --- Resume Section --- */}
      <section id="resume" className="py-32 px-6 md:px-12 text-center bg-black text-white">
        <FadeIn>
      ...
      <footer className="bg-black text-[#F3F3F3] pt-20 pb-8 px-6 md:px-12 border-t">
        ...
        <div className="max-w-7xl mx-auto mt-20 pt-8 border-t border-gray-800 flex flex-col md:flex-row justify-between items-center text-xs font-mono text-gray-600">
          <p>&copy; 2026 KARTHIK MARELLA. ALL RIGHTS RESERVED.</p>
        </div>
      </footer>
      ...
      <button
        onClick={scrollToTop}
        className={`fixed bottom-8 right-8 bg-black text-white p-4 transition-all duration-300 z-50 hover:bg-orange-600 ${showBackToTop ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10 pointer-events-none'
          }`}
      >
